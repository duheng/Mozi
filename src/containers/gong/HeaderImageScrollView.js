        ...
        >
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.sectionContent}>
              ...
              然而，这只是开始。“在城市范围内，通过光纤构建城域量子通信网络是最
              佳方案。但要实现远距离甚至全球量子通信，仅依靠光纤量子通信技术是远远不够的。”潘建伟说。[2]
              量子保密通信，能够从三个方面保障信息安全。第一， 发送者和接收者之间的信息交互是安全的，不会被窃听或盗取。
              第二，“主仆”身份能够自动确认，只有主人才能够使唤“仆人”，
              而其他人无法指挥“仆人”。第三，一旦发送者和接收者之间的传递口令被恶意篡改，使用者会立刻知晓，从而重新发送和接收指令。
              原来，用量子通信方式传递信息，传送的是光的最小能 量单元。但这种最小的颗粒，不能再被分割，也不能复
              制。即使采用目前最先进的理想单光子探测器， 在1000公里光纤中进行点对点量子通信，每300年也只能传输一个比特。
              “就好比一支拥有100万人的队伍，到最后可能只剩下几个人，
              花了很长时间才能抵达目的地。”这种受制于光纤，不能放大量子通信信号的问题，
            ...
            <Text style={styles.sectionContent}>
              量子卫星工程由中科院国家空间科学中心总负责； 中国科学技术大学负责科学目标的提出和科学应用系统的研制；
              中科院上海微小卫星创新研究院抓总研制卫星系统，中科院上海技术 物理研究所联合中科大研制有效载荷分系统；中科院国家空间科学中心牵头
              负责地面支撑系统研制、建设和运行；对地观测与数字地球科学中心等单位参加。
            </Text>
          </View>
        </HeaderImageScrollView>
      </View>
